...
onMount(() => {
    var _a;
    if ((_a = scene.physics) === null || _a === void 0 ? void 0 : _a.world) {
        let width = scene.physics.world.bounds.width < instance.widthInPixels
            ? instance.widthInPixels
            : scene.physics.world.bounds.width;
        let height = scene.physics.world.bounds.height < instance.heightInPixels
