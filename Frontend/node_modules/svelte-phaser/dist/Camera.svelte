...
export let bounds = {
    x: 0,
    y: 0,
    width: (_a = tilemap === null || tilemap === void 0 ? void 0 : tilemap.widthInPixels) !== null && _a !== void 0 ? _a : undefined,
    height: (_b = tilemap === null || tilemap === void 0 ? void 0 : tilemap.heightInPixels) !== null && _b !== void 0 ? _b : undefined,
};
/**
...
$: if (shouldApplyProps(follow)) {
    const target = typeof follow === 'string'
    ...
    if (target) {
        ...
        instance.startFollow(target, roundPixels, _lerp.x, _lerp.y, followOffsetX, followOffsetY);
    }
}
