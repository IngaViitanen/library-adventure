...
else if (shouldApplyProps(alphaTopLeft, alphaTopRight, alphaBottomLeft, alphaBottomRight)) {
    if (alphaTopLeft !== gameObject.alphaTopLeft ||
        ...
        gameObject.setAlpha(alphaTopLeft, alphaTopRight, alphaBottomLeft, alphaBottomRight);
    }
}
onGameEvent('prestep', () => {
