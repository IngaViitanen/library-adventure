<script>import { getGameObject } from '../getGameObject';
...
$: if (shouldApplyProps(tintTopLeft, tintTopRight, tintBottomLeft, tintBottomRight, tintFill)) {
    if (tintTopLeft !== gameObject.tintTopLeft ||
        tintTopRight !== gameObject.tintTopRight ||
        tintBottomLeft !== gameObject.tintBottomLeft ||
        tintBottomRight !== gameObject.tintBottomRight) {
        if (tintFill) {
            gameObject.setTintFill(tintTopLeft, tintTopRight, tintBottomLeft, tintBottomRight);
        }
        else {
            gameObject.setTint(tintTopLeft, tintTopRight, tintBottomLeft, tintBottomRight);
        }
    }
}
onGameEvent('prestep', () => {
