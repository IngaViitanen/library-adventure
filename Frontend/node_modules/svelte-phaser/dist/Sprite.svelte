...
export let instance = new Phaser.GameObjects.Sprite(scene, x, y, texture, frame);
onMount(() => {
    const spriteEventListeners = [
        createPhaserEventDispatcher(instance, dispatch, 'animationcomplete', (animation, frame, gameObject) => ({
            animation,
            frame,
            gameObject,
        })),
        createPhaserEventDispatcher(instance, dispatch, 'animationrepeat', (animation, frame) => ({
            animation,
            frame,
        })),
        createPhaserEventDispatcher(instance, dispatch, 'animationrestart', (animation, frame, gameObject) => ({
            animation,
            frame,
            gameObject,
        })),
        createPhaserEventDispatcher(instance, dispatch, 'animationstart', (animation, frame, gameObject) => ({
            animation,
            frame,
            gameObject,
        })),
