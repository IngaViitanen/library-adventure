<script>import Phaser from 'phaser';
import { getContext, setContext, onMount, tick, createEventDispatcher, } from 'svelte';
 ...
 * @type {Phaser.Scene}
 */
export let instance = new Phaser.Scene(removeUndefined({
    key,
    active,
    visible,
    pack,
...
let eventListeners = [
    createPhaserEventDispatcher(instance.input, dispatch, 'drag', (pointer, dragX, dragY) => ({
        pointer,
        dragX,
        dragY,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'dragend', (pointer) => ({
        pointer,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'dragenter', (pointer, target) => ({
        pointer,
        target,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'dragleave', (pointer, target) => ({
        pointer,
        target,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'dragover', (pointer, target) => ({
        pointer,
        target,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'dragstart', (pointer) => ({
        pointer,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'drop', (pointer, target) => ({
        pointer,
        target,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointerdown', (pointer, localX, localY, event) => ({
        pointer,
        localX,
        localY,
        event,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointermove', (pointer, localX, localY, event) => ({
        pointer,
        localX,
        localY,
        event,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointerout', (pointer, event) => ({
        pointer,
        event,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointerover', (pointer, localX, localY, event) => ({
        pointer,
        localX,
        localY,
        event,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointerup', (pointer, localX, localY, event) => ({
        pointer,
        localX,
        localY,
        event,
    })),
    createPhaserEventDispatcher(instance.input, dispatch, 'pointerwheel', (pointer, deltaX, deltaY, deltaZ, event) => ({
        pointer,
        deltaX,
        deltaY,
        deltaZ,
